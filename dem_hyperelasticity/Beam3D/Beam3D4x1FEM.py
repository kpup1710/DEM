...
File('dem_hyperelasticity/Beam3D/output/fem/elasticity/displacement.pvd') << u
File('dem_hyperelasticity/Beam3D/output/fem/elasticity/von_mises.pvd') << von_Mises
File('dem_hyperelasticity/Beam3D/output/fem/elasticity/magnitude.pvd') << u_magnitude
File('dem_hyperelasticity/Beam3D/output/fem/elasticity/Stress.pvd') << Stress